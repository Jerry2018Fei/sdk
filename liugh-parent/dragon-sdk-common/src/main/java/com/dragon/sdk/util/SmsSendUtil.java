...
import com.dragon.sdk.base.SmsSendRequest;
...
public class SmsSendUtil {
   ...
   * @return
   */
  public static SmsSendResponse sendMessage(String receiveUser, String message)
      throws BusinessException {
    String str = SIGNATURE + message;
    SmsSendRequest smsSingleRequest =
        new SmsSendRequest(ACCOUNT, PASSWORD, str, receiveUser, REPORT);
  ...
  private static String sendSmsByPost(String path, String postContent) throws BusinessException {
    ...
    try {
      ...
      if (httpRspCode == HttpURLConnection.HTTP_OK) {
        // 开始获取数据
        BufferedReader br =
            new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), CHARSET));
        String line = null;
