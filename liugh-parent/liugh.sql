...
CREATE TABLE `tb_user_thirdparty` (
  ...
  `status1` int(2) DEFAULT '1' COMMENT '状态值（1：启用，2：禁用，3：删除）',
...
INSERT INTO `tb_menu` VALUES ('101', '1', 'menu-974abc42a78040e7ac74ceecb70c02b5', 'admin:list', '用户管理列表', '1', '1', '/api/admin/manager', null);
...
INSERT INTO `tb_menu` VALUES ('1011', '101', 'menu-2fcaf1983232442e9484b48114fe59f6', 'admin:add', '新增用户', '2', '1', '', null);
INSERT INTO `tb_menu` VALUES ('1012', '101', 'menu-b3556e9a47204c8abe1bcdd50047f6b4', 'admin:edit', '编辑用户', '2', '2', '', null);
INSERT INTO `tb_menu` VALUES ('1013', '101', 'menu-08a093222ab04020886049b726a89a4c', 'admin:delete', '删除用户', '2', '3', '', null);
...
INSERT INTO `tb_role` (`role_code`, `role_name`) VALUES ('role-f7943542d87a4f028f446b71d9ede25d', 'admin');
...
CREATE TABLE `tb_user` (
  ...
  `status1` int(2) DEFAULT '2' COMMENT '状态值（1：启用，2：禁用，3：删除）',
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('admin-006efece76c8433d8974c1a2f98422b6', '13888888888', 'javaer', '$2a$10$VwPL.rHo4PETgCcLDTN2LOwE.ksgCA0jLHbVX5yXEoisHWihX7S/i', null, '1529982192887', null, '1', 'java开发');
INSERT INTO `tb_user` VALUES ('admin-190f8710857f4a239570387ffc676c39', '15802933752', 'eee', '$2a$10$VwPL.rHo4PETgCcLDTN2LOwE.ksgCA0jLHbVX5yXEoisHWihX7S/i', 'eee', '1529999033844', null, '1', 'eee');
INSERT INTO `tb_user` VALUES ('admin-573388ebd14348cf8b546a6bfdf98ca3', '18792420526', '5', '$2a$10$VwPL.rHo4PETgCcLDTN2LOwE.ksgCA0jLHbVX5yXEoisHWihX7S/i', '5', '1530086891950', null, '1', '5');
...
-- ----------------------------
INSERT INTO `tb_user_to_role` VALUES ('2', 'admin-006efece76c8433d8974c1a2f98422b6', 'role-cf8fea2055344df59a0d3e80540c78f9');
INSERT INTO `tb_user_to_role` VALUES ('3', 'admin-190f8710857f4a239570387ffc676c39', 'role-f7943542d87a4f028f446b71d9ede25d');
INSERT INTO `tb_user_to_role` VALUES ('4', 'admin-573388ebd14348cf8b546a6bfdf98ca3', 'role-f7943542d87a4f028f446b71d9ede25d');
...
-- Records of tb_order
-- ----------------------------
INSERT INTO `tb_order` VALUES ('770480571594227712', 'admin-006efece76c8433d8974c1a2f98422b6', '770480571594227712', 'postman', 'Product', '1539763171888', 'waitDelivery', '4540000', '0', '4540000', '0', '0', 'N', '{\"receiptType\":\"普通纸质发票\",\"receiptTitle\":\"公司\",\"receiptContent\":\"中国\"}', null, '13888888888', '刘大神', '西安', 'Y', 'A', null, null, null, null);
INSERT INTO `tb_order` VALUES ('770480571984297984', 'admin-006efece76c8433d8974c1a2f98422b6', '770480571594227713', 'postman', 'Product', '1539763171888', 'waitReceive', '3360000', '0', '3360000', '0', '0', 'N', '{\"receiptType\":\"普通纸质发票\",\"receiptTitle\":\"公司\",\"receiptContent\":\"中国\"}', null, '13888888888', '刘大神', '西安', 'N', 'A', null, null, null, null);
INSERT INTO `tb_order` VALUES ('770480572001075200', 'admin-006efece76c8433d8974c1a2f98422b6', '770480571594227714', 'postman', 'Product', '1539763171888', 'waitDelivery', '1180000', '0', '1180000', '0', '0', 'N', '{\"receiptType\":\"普通纸质发票\",\"receiptTitle\":\"公司\",\"receiptContent\":\"中国\"}', '872003869557731328', '13888888888', '刘大神', '西安', 'N', 'A', null, null, null, null);
